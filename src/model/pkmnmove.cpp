...
const PkmnMove PkmnMoveList::_movesList[] = {
  ...
  PkmnMove( 13, "Razor Wind"   , Element::NORMAL  , Type::SPECIAL , 10,  80,  75),
	PkmnMove( 14, "Sword Dance"  , Element::NORMAL  , Type::STATUS  , 30,   0, 100),
	PkmnMove( 15, "Cut"          , Element::NORMAL  , Type::PHYSICAL, 30,  50,  95),
  PkmnMove( 16, "Gust "        , Element::NORMAL  , Type::SPECIAL , 35,  40, 100),
  PkmnMove( 17, "Wing Attack"  , Element::FLYING  , Type::PHYSICAL, 35,  35, 100),
	PkmnMove( 18, "Whirlwind"    , Element::FLYING  , Type::STATUS  , 20,   0, 100),
  PkmnMove( 19, "Fly"          , Element::FLYING  , Type::PHYSICAL, 15,  70,  95),
  PkmnMove( 20, "Bind "        , Element::NORMAL  , Type::PHYSICAL, 20,  15,  75),
	PkmnMove( 21, "Slam "        , Element::NORMAL  , Type::PHYSICAL, 20,  80,  75),
  PkmnMove( 22, "Vine Whip"    , Element::GRASS   , Type::PHYSICAL, 10,  35, 100),
  ...
  PkmnMove( 26, "Jump Kick"    , Element::FIGHTING, Type::PHYSICAL, 25,  70,  95),
	PkmnMove( 27, "Rolling Kick ", Element::FIGHTING, Type::PHYSICAL, 15,  60,  85),
  PkmnMove( 28, "Sand Attack"  , Element::NORMAL  , Type::STATUS  , 15,   0, 100),
  ...
  PkmnMove( 33, "Tackle"       , Element::NORMAL  , Type::PHYSICAL, 30,  35,  95),
	PkmnMove( 34, "Body Slam"    , Element::NORMAL  , Type::PHYSICAL, 15,  85, 100),
  PkmnMove( 35, "Wrap "        , Element::NORMAL  , Type::PHYSICAL, 20,  15,  85),
	PkmnMove( 36, "Take Down"    , Element::NORMAL  , Type::PHYSICAL, 20,  90,  85),
  PkmnMove( 37, "Thrash"       , Element::NORMAL  , Type::PHYSICAL, 20,  90, 100),
  PkmnMove( 38, "Double Edge"  , Element::NORMAL  , Type::PHYSICAL, 15, 100, 100),
  ...
  PkmnMove( 49, "Sonic Boom"   , Element::NORMAL  , Type::SPECIAL , 20,  20,  90),
  PkmnMove( 50, "Disable"      , Element::NORMAL  , Type::STATUS  , 20,   0,  80),
  ...
  PkmnMove( 59, "Blizzard"     , Element::ICE     , Type::SPECIAL ,  5, 120,  90),
  ...
  PkmnMove( 67, "Low Kick"     , Element::FIGHTING, Type::PHYSICAL, 20,  50,  90),
  ...
  PkmnMove( 71, "Absorb"       , Element::GRASS   , Type::SPECIAL , 20,  20, 100),
  PkmnMove( 72, "Mega Drain"   , Element::GRASS   , Type::SPECIAL , 10,  40, 100),
  ...
  PkmnMove( 80, "Petal Dance"  , Element::GRASS   , Type::SPECIAL , 20,  70, 100),
	PkmnMove( 81, "String Shot"  , Element::BUG     , Type::STATUS  , 40,   0,  95),
  PkmnMove( 82, "Dragon Rage"  , Element::DRAGON  , Type::SPECIAL , 10,  40, 100),
  PkmnMove( 83, "Fire Spin"    , Element::FIRE    , Type::SPECIAL , 15,  15,  70),
  ...
  PkmnMove(105, "Recover"      , Element::NORMAL  , Type::STATUS  , 20,   0,   0),
  ...
  PkmnMove(128, "Clamp"        , Element::WATER   , Type::PHYSICAL, 10,  35,  75),
  ...
  PkmnMove(136, "Hi Jump Kick ", Element::FIGHTING, Type::PHYSICAL, 20,  85,  90),
  PkmnMove(137, "Glare"        , Element::NORMAL  , Type::STATUS  , 30,   0,  75),
	PkmnMove(138, "Dream Eater"  , Element::PSYCHIC , Type::SPECIAL , 15, 100, 100),
  PkmnMove(139, "Poison Gas"   , Element::POISON  , Type::STATUS  , 40,   0,  55),
  ...
  PkmnMove(148, "Flash"        , Element::NORMAL  , Type::STATUS  , 20,   0,  70),
  ...
  PkmnMove(152, "Crabhammer"   , Element::WATER   , Type::PHYSICAL, 10,  90,  85),
